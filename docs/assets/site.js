...
const copy = {
  zh: {
    ...
    installStep1Title: "下载源码", installStep1Body: "从 GitHub Releases 下载名为 ZZ-Project-v0.1.0-source.zip 的附件，或使用 Git 与 Git LFS 克隆 main。",
  ...
  ja: {
    ...
    installStep1Title: "ソースを取得", installStep1Body: "GitHub Releases から ZZ-Project-v0.1.0-source.zip をダウンロードするか、Git と Git LFS で main をクローンします。",
  ...
  en: {
    ...
    installStep1Title: "Get the source", installStep1Body: "Download ZZ-Project-v0.1.0-source.zip from GitHub Releases, or clone main with Git and Git LFS.",
