...
const RELEASE_CONFIG = {
  ...
  programUrl: "https://github.com/TohmaN233/ZZ-Project/releases/download/v0.3.0/ZZ-Project-v0.3.0-Windows-Setup.exe",
  linuxBundleUrl: "https://github.com/TohmaN233/ZZ-Project/releases/download/v0.3.0/ZZ-Project-v0.3.0-Linux.tar.gz",
...
const copy = {
  zh: {
    ...
    heroInstall: "查看安装方法", heroExplore: "了解当前版本", heroPlatforms: "Windows · Linux/macOS 使用 .sh", heroLanguage: "中文 / 日本語 / English",
    statusOneTitle: "当前卡池", statusOneBody: "基础卡 + EX01 + PC01 + PC01R + PC02", statusTwoTitle: "对战方式", statusTwoBody: "单机 / 局域网 / 在线",
    statusThreeTitle: "AI 档位", statusThreeBody: "Greedy + 两档 RL", statusFourTitle: "版本状态", statusFourBody: "v0.3.0 · PC02",
    ...
    truthBody: "作者拥有统计学学位，但没有修读强化学习课程，研究方向也与此无关；模型训练规模同样不大。电脑 AI 的训练数据和卡池目前只覆盖 PC01，PC01R、EX01、PC02 没有进入训练流程。当前 AI 与 ZENONZARD 正式运营时期万代使用的 AI 仍有明显差距。相关实现由 Codex 协助编写，并参考了 ygo-agent 的公开方法与工程结构。",
    ...
    screensEyebrow: "Actual UI", screensTitle: "完整 ZZ 体验：当前卡池包含 PC02", screenBattleLabel: "实机对战界面",
    ...
    onlineLink: "查看联机说明 →", onlineDemo: "联机版本演示 →", contentEyebrow: "CONTENT STATUS", contentTitle: "当前内容边界",
    poolTitle: "卡池", poolBody: "当前包含基本卡、EX01、PC01、PC01R 与 PC02。", testingTitle: "测试", testingBody: "个人项目无法覆盖足够多的组合测试，当前版本可能仍有小型规则或界面问题。",
    englishTitle: "英文版", englishBody: "英文卡图与文本是独立资源包；未覆盖的图仍可能回退到官网 URL。",
    musicTitle: "BGM", musicBody: "顶部栏或基础设置中可选择对战 BGM；完整资源包包含 ZZ 各角色歌曲。",
    thanksTitle: "致谢", thanksBody: "感谢 theFeri 提供 50+ 张高清 playmat 图，以及 Valkyrie 提供英文文本。",
    installEyebrow: "INSTALLATION", installTitle: "Windows 安装包、Linux bundle 与大型资源分开下载",
    installLead: "Windows 安装包已经包含可玩的桌面客户端、冻结后的 Python server 和默认模型；Linux 提供 portable bundle；卡图、角色图、视频与音乐仍放在独立资源包中。",
    installStep1Title: "下载对应平台版本", installStep1Body: "Windows 下载并运行 ZZ-Project-v0.3.0-Windows-Setup.exe；Linux 下载 ZZ-Project-v0.3.0-Linux.tar.gz 并运行 launch-electron.sh；macOS 和开发者使用源码包。",
    ...
    installStep4Title: "启动客户端", installStep4Body: "Windows 安装包从开始菜单或桌面快捷方式启动；Linux bundle 解压后运行 ./launch-electron.sh；源码版本使用 .cmd、.sh 或 npm run electron:dev。",
    requirementsTitle: "运行要求", reqOs: "系统", reqOsBody: "Windows 10/11 安装包；Linux portable bundle；macOS 源码启动（实验支持）", reqPython: "Windows 安装包无需；Linux bundle 首次启动自备 runtime；源码需要 3.10+", reqNode: "Windows 安装包无需；Linux bundle 首次启动自备 runtime；源码需要 20+", reqGpu: "显卡", reqGpuBody: "游玩不要求；本地训练需要 NVIDIA GPU / CUDA",
    downloadCode: "下载 Windows 安装包", downloadLinux: "下载 Linux portable 包", downloadAssets: "下载资源包（含英文包）", hashNote: "Windows 安装包、Linux bundle、两个主资源 volume 与英文 ZIP 的大小和 SHA-256 已记录在资源清单和发布说明中，便于检查下载完整性。",
  ...
  ja: {
    ...
    heroInstall: "導入方法を見る", heroExplore: "現行版を知る", heroPlatforms: "Windows · Linux/macOS は .sh", heroLanguage: "中文 / 日本語 / English",
    statusOneTitle: "現在のカードプール", statusOneBody: "ベーシック + EX01 + PC01 + PC01R + PC02", statusTwoTitle: "対戦方法", statusTwoBody: "オフライン / LAN / オンライン",
    statusThreeTitle: "AI レベル", statusThreeBody: "Greedy + RL 2段階", statusFourTitle: "リリース", statusFourBody: "v0.3.0 · PC02",
    ...
    truthBody: "作者は統計学の学位を持ちますが、強化学習の授業を履修した経験はなく、研究分野も別領域です。コンピューター AI の学習データとカードプールは現在 PC01 のみで、PC01R、EX01、PC02 は学習に含まれていません。学習規模も小さく、正式サービス時にバンダイが使用していた AI とは大きな差があります。実装は Codex の支援を受け、ygo-agent の公開手法と構成を参考にしています。",
    ...
    screensEyebrow: "Actual UI", screensTitle: "ZZ を一通り体験：現在のカードプールは PC02 まで", screenBattleLabel: "実際の対戦画面",
    ...
    onlineLink: "オンライン対戦の説明を見る →", onlineDemo: "オンライン版デモ →", contentEyebrow: "CONTENT STATUS", contentTitle: "現在の収録範囲",
    poolTitle: "カード", poolBody: "現在はベーシックカード、EX01、PC01、PC01R、PC02 を収録しています。", testingTitle: "テスト", testingBody: "個人開発のため、十分な組み合わせテストはできておらず、小さなルール・表示不具合が残る可能性があります。",
    englishTitle: "英語版", englishBody: "英語カード画像とテキストは独立アセットパックで配布しています。未収録の画像は公式 URL にフォールバックする場合があります。",
    musicTitle: "BGM", musicBody: "トップバーまたは基本設定から対戦 BGM を選択できます。完全版アセットパックには ZZ のキャラクターソングが含まれます。",
    thanksTitle: "謝辞", thanksBody: "50 枚以上の高解像度 playmat 画像を提供してくださった theFeri と、英語テキストを提供してくださった Valkyrie に感謝します。",
    installEyebrow: "INSTALLATION", installTitle: "Windows インストーラー、Linux bundle、大型アセットを別配布",
    installLead: "Windows インストーラーには遊べるデスクトップクライアント、凍結済み Python server、既定モデルが含まれます。Linux には portable bundle を用意し、カード画像、キャラクター、動画、音楽は別アセットパックです。",
    installStep1Title: "対応する版を取得", installStep1Body: "Windows は ZZ-Project-v0.3.0-Windows-Setup.exe、Linux は ZZ-Project-v0.3.0-Linux.tar.gz を取得します。macOS と開発者はソース版を使用します。",
    ...
    installStep4Title: "クライアントを起動", installStep4Body: "インストーラー版はスタートメニューまたはデスクトップショートカットから起動します。Linux bundle は展開後に ./launch-electron.sh、ソース版は .cmd、.sh、または npm run electron:dev を使用します。",
    requirementsTitle: "動作要件", reqOs: "OS", reqOsBody: "Windows 10/11 インストーラー。Linux portable bundle。macOS はソース起動の実験対応", reqPython: "Windows インストーラー不要。Linux bundle は初回起動時に runtime を準備。ソース版は 3.10+", reqNode: "Windows インストーラー不要。Linux bundle は初回起動時に runtime を準備。ソース版は 20+", reqGpu: "GPU", reqGpuBody: "通常プレイは不要。ローカル学習には NVIDIA GPU / CUDA が必要",
    downloadCode: "Windows インストーラーをダウンロード", downloadLinux: "Linux portable bundle をダウンロード", downloadAssets: "アセットをダウンロード（英語版含む）", hashNote: "Windows インストーラー、Linux bundle、2 つの主アセット volume、英語 ZIP のサイズと SHA-256 はアセットマニフェストとリリースノートに記載されています。",
  ...
  en: {
    ...
    heroInstall: "Installation guide", heroExplore: "Explore this release", heroPlatforms: "Windows · Linux/macOS via .sh", heroLanguage: "Chinese / Japanese / English",
    statusOneTitle: "Card pool", statusOneBody: "Basic + EX01 + PC01 + PC01R + PC02", statusTwoTitle: "Play", statusTwoBody: "Offline / LAN / Online",
    statusThreeTitle: "AI tiers", statusThreeBody: "Greedy + two RL tiers", statusFourTitle: "Release", statusFourBody: "v0.3.0 · PC02",
    ...
    screensEyebrow: "Actual UI", screensTitle: "The full ZZ experience: current card pool through PC02", screenBattleLabel: "In-game battle UI",
    ...
    onlineLink: "Read the online guide →", onlineDemo: "Watch the online demo →", contentEyebrow: "CONTENT STATUS", contentTitle: "Current scope",
    poolTitle: "Card pool", poolBody: "The current pool contains the basic cards, EX01, PC01, PC01R, and PC02.", testingTitle: "Testing", testingBody: "A personal project cannot cover enough card combinations, so small rules or UI bugs may remain.",
    ...
    musicTitle: "BGM", musicBody: "Choose the battle BGM from the persistent top bar or Settings. The complete asset pack contains ZZ character songs.",
    ...
    installEyebrow: "INSTALLATION", installTitle: "Windows installer, Linux bundle, and large media assets are separate downloads",
    installLead: "The Windows installer contains the playable desktop client, frozen Python server, and default models. Linux has a portable bundle; card art, characters, video, and music remain in a separate asset pack.",
    installStep1Title: "Get the build for your platform", installStep1Body: "Windows players should run ZZ-Project-v0.3.0-Windows-Setup.exe. Linux players should extract ZZ-Project-v0.3.0-Linux.tar.gz and run launch-electron.sh. macOS players and developers should use the source package.",
    ...
    installStep4Title: "Launch", installStep4Body: "Launch the installed Windows build from the Start menu or desktop shortcut. Linux bundles run ./launch-electron.sh after extraction. Source builds use .cmd, .sh, or npm run electron:dev.",
    requirementsTitle: "Requirements", reqOs: "OS", reqOsBody: "Windows 10/11 installer; Linux portable bundle; experimental source launch on macOS", reqPython: "Not needed for Windows installer; Linux bundle prepares its runtime on first launch; 3.10+ for source", reqNode: "Not needed for Windows installer; Linux bundle prepares its runtime on first launch; 20+ for source", reqGpu: "GPU", reqGpuBody: "Not required to play; local training needs an NVIDIA GPU and CUDA",
    downloadCode: "Download Windows installer", downloadLinux: "Download Linux portable bundle", downloadAssets: "Download assets (English pack included)", hashNote: "The Windows installer, Linux bundle, two main volumes, and English ZIP sizes and SHA-256 values are recorded in the release manifest and notes for integrity checks.",
