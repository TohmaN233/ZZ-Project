...
const copy = {
  zh: {
    ...
    heroInstall: "查看安装方法", heroExplore: "了解当前版本", heroLanguage: "中文 / 日本語 / English",
    ...
    installStep4Title: "启动客户端", installStep4Body: "双击 launch-electron.cmd；也可以运行 npm run electron:dev。",
    requirementsTitle: "运行要求", reqOs: "系统", reqGpu: "显卡", reqGpuBody: "游玩不要求；本地训练需要 NVIDIA GPU / CUDA",
  ...
  ja: {
    ...
    heroInstall: "導入方法を見る", heroExplore: "現行版を知る", heroLanguage: "中文 / 日本語 / English",
    ...
    installStep4Title: "クライアントを起動", installStep4Body: "launch-electron.cmd をダブルクリックするか、npm run electron:dev を実行します。",
    requirementsTitle: "動作要件", reqOs: "OS", reqGpu: "GPU", reqGpuBody: "通常プレイは不要。ローカル学習には NVIDIA GPU / CUDA が必要",
  ...
  en: {
    ...
    heroInstall: "Installation guide", heroExplore: "Explore this release", heroLanguage: "Chinese / Japanese / English",
    ...
    installStep4Title: "Launch", installStep4Body: "Double-click launch-electron.cmd, or run npm run electron:dev.",
    requirementsTitle: "Requirements", reqOs: "OS", reqGpu: "GPU", reqGpuBody: "Not required to play; local training needs an NVIDIA GPU and CUDA",
